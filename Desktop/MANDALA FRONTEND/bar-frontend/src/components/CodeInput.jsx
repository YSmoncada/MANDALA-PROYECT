  ...
  return (
    <div className="bg-[#441E73]/90 border border-[#6C3FA8] p-8 rounded-2xl shadow-lg w-full max-w-md text-center">
      ...
      <input
        ...
        className="w-full text-center text-xl tracking-[1rem] p-3 rounded-lg bg-[#2B0D49] text-white placeholder-[#8A7BAF] focus:outline-none focus:ring-2 focus:ring-[#A944FF]"
      />
