...
export const UI_CLASSES = {
    // Layouts
    pageContainer: "min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-black p-8 relative selection:bg-purple-500/30",
    glassCard: "bg-gray-900/50 backdrop-blur-sm border border-purple-500/30 rounded-2xl shadow-2xl p-8",
