...
const AdminUsuariosDisco = () => {
  ...
  const handleAddProfileSubmit = async (e) => {
    ...
    if (newProfileName.trim() === "" || newProfileCode.length < 4) {
      toast.error(
        "El nombre y la contraseña (min 4 caracteres) son obligatorios.",
      );
      return;
    }
  ...
  return (
    <PageLayout title="Gestión de Personal">
      <div className="max-w-7xl mx-auto space-y-16 pb-24">
        {/* Global Actions */}
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6 px-4 sm:px-0">
          ...
          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
            <button
              ...
              className="flex items-center justify-center gap-3 px-8 py-4 rounded-2xl bg-[#0E0D23] dark:bg-zinc-900 border border-white/5 text-[#8A7BAF] dark:text-zinc-400 hover:text-white transition-all font-black text-[10px] uppercase tracking-[0.2em] shadow-2xl active:scale-95 w-full sm:w-auto"
            >
              <Settings size={18} />
              Configurar Ticket
            </button>
            ...
            <button
              ...
              className="flex items-center justify-center gap-3 px-10 py-4 rounded-2xl bg-[#A944FF] dark:bg-white text-white dark:text-black hover:brightness-110 transition-all font-black text-[10px] uppercase tracking-[0.2em] shadow-[0_20px_40px_-10px_rgba(169,68,255,0.4)] dark:shadow-none active:scale-95 w-full sm:w-auto"
            >
              <Plus size={18} />
              Nuevo Personal
            </button>
        ...
        {loading && usuarios.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-40 animate-fadeIn">
            ...
            <p className="text-[#8A7BAF] dark:text-zinc-500 font-black tracking-[0.4em] text-[11px] animate-pulse uppercase">
          ...
          <div className="space-y-24 animate-fadeIn">
            ...
            <section className="px-4 sm:px-0">
              <div className="flex items-center gap-6 mb-12">
                ...
                <span className="text-[10px] font-black text-[#8A7BAF] dark:text-zinc-600 uppercase tracking-[0.2em] bg-[#1A103C] px-4 py-1.5 rounded-full border border-white/5">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
                ...
                {usuarios.length === 0 && !loading && (
                  <div className="col-span-full py-24 text-center bg-[#1A103C]/30 dark:bg-zinc-900/30 rounded-[3rem] border-2 border-dashed border-white/5 shadow-inner">
                    <p className="text-[#8A7BAF] font-black uppercase tracking-[0.25em] text-[10px]">
      ...
      {showModal && (
        <div
          className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-black/95 backdrop-blur-md animate-fadeIn"
          onClick={() => setShowModal(false)}
        >
          <div
            className="bg-[#1A103C]/95 dark:bg-zinc-900 w-full max-w-sm relative rounded-[2.5rem] p-10 shadow-2xl border border-white/10 transform animate-scaleIn"
          ...
          >
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-[#8A7BAF] text-[10px] mt-4 uppercase tracking-[0.3em] font-black">
                Perfil:{" "}
                <span className="text-white bg-[#A944FF] px-2 py-0.5 rounded ml-1">
                  {selectedItem?.username || selectedItem?.nombre}
                </span>
              </p>
            </div>
            ...
            <div className="space-y-8">
              <div className="group relative">
                ...
                <input
                  ...
                  onKeyPress={(e) =>
                    e.key === "Enter" && handleUpdateCredentials()
                  }
