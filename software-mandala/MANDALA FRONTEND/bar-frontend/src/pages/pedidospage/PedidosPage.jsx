              ...
              <div className="flex flex-col gap-4 max-h-96 overflow-y-auto pr-2 mb-4">
                {orderItems.map((item, index) => (
                  <div
                    ...
                    className="flex flex-col sm:flex-row justify-between sm:items-center text-white bg-black/20 p-3 rounded-lg gap-4"
                  >
                    ...
                    {/* Parte Derecha: Controles y Precio */}
                    <div className="flex items-center justify-between sm:justify-end gap-4 w-full sm:w-auto">
                      {/* Controles de cantidad */}
                      <div className="flex items-center gap-1 bg-purple-900/50 rounded-full p-1">
                        <button
                          onClick={() => {
                            if (item.cantidad > 1) {
                          ...
                          className="w-7 h-7 flex items-center justify-center text-lg rounded-full hover:bg-purple-700 transition-colors"
                        >
                          -
                        </button>
                        <span className="px-1 font-bold text-md w-6 text-center">{item.cantidad}</span>
                        <button
