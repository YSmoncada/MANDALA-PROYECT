        ...
        <div className="min-h-screen bg-transparent dark:bg-black text-white dark:text-white transition-colors duration-500 selection:bg-[#A944FF]/30 dark:selection:bg-white/10">
            ...
            <div className="relative z-10 max-w-7xl mx-auto p-6 sm:p-10 pt-32">
                ...
                {loading ? (
                    ...
                    <div className="text-center py-12 px-8 bg-[#1A103C]/80 dark:bg-zinc-900/30 rounded-[3rem] border border-white/10 dark:border-white/5 backdrop-blur-2xl max-w-md mx-auto shadow-2xl dark:shadow-none animate-scaleIn">
                        <div className="inline-block p-6 rounded-[2rem] bg-[#0E0D23] dark:bg-zinc-800/30 mb-6 border border-white/5 shadow-inner">
                            <ShoppingBag size={48} className="text-[#A944FF] dark:text-white opacity-80" />
                        </div>
                        <p className="text-xl font-black mb-3 uppercase tracking-tighter text-white italic">No tienes pedidos activos</p>
                        <p className="text-[#8A7BAF] dark:text-zinc-500 mb-8 font-black uppercase tracking-[0.2em] text-[10px]">Comienza a tomar pedidos para verlos aquí</p>
                        <button
                            onClick={() => navigate('/pedidos-disco')}
                            className="px-12 py-5 bg-gradient-to-r from-[#8A44FF] to-[#A944FF] dark:from-white dark:to-zinc-200 text-white dark:text-black hover:brightness-110 rounded-2xl font-black shadow-xl transition-all active:scale-95 uppercase text-[11px] tracking-[0.3em] border border-white/20 dark:border-transparent"
                        >
                            Tomar Nuevo Pedido
                        </button>
                    </div>
