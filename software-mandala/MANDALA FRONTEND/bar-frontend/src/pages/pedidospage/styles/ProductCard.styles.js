...
export const CARD_STYLES = {
    container: `group relative bg-[#1A103C]/80 dark:bg-zinc-900/10 backdrop-blur-2xl 
                ...
                shadow-2xl hover:shadow-[0_80px_100px_-20px_rgba(0,0,0,0.8)] border border-white/5 dark:border-white/5 
                hover:border-[#A944FF]/40 dark:hover:border-white/20 transform-gpu hover:-translate-y-2`,
    imageWrapper: `relative aspect-square w-full mb-3 overflow-hidden rounded-xl bg-[#0E0D23] dark:bg-white/5 
                   p-2 flex items-center justify-center shadow-inner group-hover:scale-[1.02] transition-transform duration-700`,
    ...
    footer: `mt-auto pt-4 border-t border-white/[0.03] space-y-4`,
    ...
    counter: `flex items-center bg-black/40 dark:bg-black/20 rounded-xl border border-white/5 dark:border-white/5 p-1`,
