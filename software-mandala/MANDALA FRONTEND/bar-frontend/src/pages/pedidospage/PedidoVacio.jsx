...
const PedidoVacio = memo(() => {
    ...
    return (
        <div className="text-center py-20 px-10 bg-[#1A103C]/80 dark:bg-zinc-900/30 rounded-[3rem] border border-white/10 dark:border-white/5 backdrop-blur-2xl max-w-2xl mx-auto shadow-2xl dark:shadow-none animate-scaleIn w-full">
