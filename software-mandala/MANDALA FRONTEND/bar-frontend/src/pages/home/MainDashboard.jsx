...
const DarkModeToggle = ({ isDarkMode, onToggle }) => (
    <button
        onClick={onToggle}
        className="sm:absolute sm:top-6 sm:left-6 mb-4 sm:mb-0 flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 hover:bg-zinc-800/50 hover:border-zinc-700 text-zinc-400 hover:text-white transition-all backdrop-blur-sm shadow-lg group z-50"
