      ...
      <main className="flex flex-col items-center justify-center pt-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center w-48 h-48 bg-white/10 hover:bg-white/20 rounded-2xl border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 shadow-lg"
          >
            <SquareKanban className="w-16 h-16 mb-4 text-purple-300" />
          ...
          <button
            ...
            className="flex flex-col items-center justify-center w-48 h-48 bg-white/10 hover:bg-white/20 rounded-2xl border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 shadow-lg"
          >
            <History className="w-16 h-16 mb-4 text-purple-300" />
          ...
          <button
            ...
            className="flex flex-col items-center justify-center w-48 h-48 bg-white/10 hover:bg-white/20 rounded-2xl border border-purple-400/30 hover:border-purple-400/60 transition-all duration-300 shadow-lg"
          >
            <GlassWater className="w-16 h-16 mb-4 text-purple-300" />
            <span className="text-lg font-semibold">Bartender</span>
          </button>
        </div>
      </main>
    </div>
