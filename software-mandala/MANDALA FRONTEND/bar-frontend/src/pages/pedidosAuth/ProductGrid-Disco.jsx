        ...
        <div className="w-full pb-20">
                    ...
                    <div className="flex flex-wrap justify-center gap-2 sm:gap-3 px-4">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`
                                    px-4 sm:px-8 py-2.5 sm:py-3 rounded-xl text-[10px] sm:text-xs font-bold uppercase tracking-widest transition-all duration-300 border
                                    ${filtro === cat.id
            ...
            {loading ? (
                <div className="flex flex-col items-center justify-center py-32">
                    ...
                    <p className="text-purple-400 font-bold tracking-widest text-xs">CARGANDO MENÚ...</p>
                </div>
                ...
                <div className="text-center py-32 px-4">
                    ...
                    <p className="text-[#8A7BAF] text-sm uppercase tracking-widest font-bold">Prueba con otra categoría</p>
                </div>
            )}
        </div>
    );
