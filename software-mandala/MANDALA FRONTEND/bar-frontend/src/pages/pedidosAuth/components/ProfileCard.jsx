    ...
    return (
        ...
        >
            <div className="relative p-1 rounded-full border border-transparent group-hover:border-emerald-500/50 transition-all duration-300">
                <div className="w-10 h-10 rounded-full bg-zinc-900 border border-zinc-800 flex items-center justify-center text-sm font-light text-zinc-400 group-hover:text-emerald-400 group-hover:bg-zinc-800 shadow-2xl transition-all overflow-hidden">
